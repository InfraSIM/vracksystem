...
from app.view import views, kvm, vpdu, vnode, support
from app.view import esxi, docker, vnodecustom, index, vrackdeploy
import app
import django
...
urlpatterns = [
    ...
    url(r'^$', app.view.index.main, name='index'),
    ...
    url(r'^docs/', include(rest_framework.urls)),
]
